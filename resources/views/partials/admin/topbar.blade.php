<header class="d-flex justify-content-between align-items-center bg-white p-3 mb-4">
    ...
    <div class="topbar-left">
        ...
        @elseif(request()->Routeis('admin.berita*') || request()->is('admin.berita*'))
            ...
            <p class="text-secondary">Tambah, ubah, atau hapus postingan berita sekolah.</p>
